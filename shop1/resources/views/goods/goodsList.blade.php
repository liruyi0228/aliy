            ...
            <div class="all-list-wrapper">
                ...
                <div class="menu-list-wrapper" id="divSortList">
                    <ul id="sortListUl" class="list">
                        <li sortid='0' class='current cate' cateid="0" ><span class='items'>全部商品</span></li>
                        @foreach($cateInfo as $v)
                            <li sortid='100' reletype='1' linkaddr='' class="cate" cateid="{{$v->cate_id}}">
                            ...
                            <div class="goodList mui-scroll">
                                <ul id="ulGoodsList" class="mui-table-view mui-table-view-chevron">
                                    ...
                                    <span class="gList_l fl">
                                        <a href="{{url('goods/goodscontent')}}/{{$v->goods_id}}"><img class="lazy" src="{{url('/uploads')}}/{{$v->goods_img}}"></a>
                                    </span>
                                        <div class="gList_r">
                                            ...
                                            <div class="gRate">
                                                ...
                                                <a codeid="12785750" canbuy="646" goods_id="{{$v->goods_id}}" class="goodsid"><s></s></a>
                                            </div>
                                        </div>
                                    </li>
                                    @endforeach
    ...
    $(function(){
        ...
        layui.use(['layer'],function(){
            ...
            $(".goodsid").click(function(){
                ...
                var type=1;
                $.post(
                    "{{url('goods/goodscartadd')}}",
                    {_token:_token,goods_id:goods_id,type:type},
                    function(res){
                        //console.log(res);
                        if(res==3){
                            //layer.msg("密码不能为空");
        ...
        $(".cate").click(function(){
            ...
            // console.log(_this.addClass('current'));
        })
    })
</script>
{{--</script>--}}
